...
const theme = (darkMode, color) => ({
  ...
  text1: darkMode ? '#FAFAFA' : '#452a7a',
  text2: darkMode ? '#C3C5CB' : '#565A69',
  text3: darkMode ? '#6C7284' : '#888D9B',
  text4: darkMode ? '#565A69' : '#C3C5CB',
  text5: darkMode ? '#2C2F36' : '#EDEEF2',
  text6: darkMode ? '#52d785' : '#2C2F36',
  ...
  bg7: darkMode ? 'linear-gradient(#28313b, #1F2B46)' : 'linear-gradient(#eef2f3, #e6fdff)',
  bg8: darkMode ? 'linear-gradient(#28313b, #1F2B46)' : 'linear-gradient(#eef2f3, #e6fdff)',
  ...
  //primary colors
  primary1: darkMode ? '#60d6dc' : '#52d785',
  ...
  // secondary colors
  secondary1: darkMode ? '#60d6dc' : '#ff007a',
  ...
  yellow1: '#FFE270',
  yellow2: '#F3841E',
  link: darkMode ? '#60d6dc' : '#452a7a',
  blue: darkMode ? '#60d6dc' : '#452a7a',
  //#e6fdff
